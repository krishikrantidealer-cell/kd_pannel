...
class _EditTemplateDialogState extends State<EditTemplateDialog> {
  late final String _tplId;
  late final TextEditingController _titleCtrl;
  late final TextEditingController _bodyCtrl;
  late final TextEditingController _imgCtrl;
  late final TextEditingController _btn1Ctrl;
  late final TextEditingController _btn2Ctrl;
  late String _actionRoute;

  @override
  void initState() {
    super.initState();
    _tplId = (widget.template['_id'] ?? widget.template['id'])?.toString() ?? '';
    _titleCtrl = TextEditingController(text: widget.template['title'] ?? '');
    _bodyCtrl = TextEditingController(text: widget.template['body'] ?? '');
    _imgCtrl = TextEditingController(text: widget.template['imageUrl'] ?? '');
    _btn1Ctrl = TextEditingController(
      text: widget.template['button1'] ?? widget.template['btn1Text'] ?? '⚡ Open Offer',
    );
    _btn2Ctrl = TextEditingController(
      text: widget.template['button2'] ?? widget.template['btn2Text'] ?? '📞 Call Support',
    );
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Update notification copy, tags and landing deep link',
                          style: GoogleFonts.outfit(
                            fontSize: 12,
